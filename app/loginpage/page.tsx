...
export default function LoginPage() {
  ...
  const handleSocialLogin = async (provider: Provider) => {
    ...
    await signIn(provider, {
      callbackUrl: '/loginpage/redirect',
      redirect: true
    })
  }
      ...
      <div className="w-full max-w-md px-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="cursor-pointer w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-md bg-white hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed relative"
          >
            <>
          ...
          <button
            ...
            disabled={isLoading}
            className="cursor-pointer w-full flex items-center justify-center gap-3 px-4 py-3 rounded-md bg-[#FEE500] hover:bg-[#FDD835] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <>
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                <path
          ...
          <button
            ...
            disabled={isLoading}
            className="cursor-pointer w-full flex items-center justify-center gap-3 px-4 py-3 rounded-md bg-[#03C75A] hover:bg-[#02B350] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <>
