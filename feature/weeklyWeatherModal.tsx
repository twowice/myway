   ...
   return (
      <div>
         ...
         >
            ...
            >
               <h2 style={{ margin: 0, fontSize: '16px', fontWeight: 'bold' }}>주간 날씨</h2>
               <button
                  onClick={onClose}
                  style={{
                     background: 'none',
            ...
            <div style={{ padding: '0 16px 16px 16px' }}>
               {weeklyWeather?.map((day, index) => {
                  return (
                     ...
                     >
                        {/* 날짜 */}
                        <div style={{ flex: 1, fontSize: '12px', color: '#04152F' }}>{formatDate(day.date)}</div>
                        ...
                        {/* 강수량 */}
                        <div style={{ flex: 1, fontSize: '12px', color: '#04152F', textAlign: 'center' }}>
